...
//		double _Om, double _w, double _M0, double _T, double mass, double ep)
//: T(_T), a(_a), e(_e), q(0.0), i(_i), Om(_Om), w(_w), M0(_M0),
//  perigee(0), epoch(ep), GM(0.0),
//  plane(quatd_t::Identity())
//{
...
////	std::cout << "Inclination:            " << toDegrees(i) << std::endl;
////	std::cout << "Semimajor Axis:         " << a << std::endl;
////	std::cout << "Perigee:                " << perigee << std::endl;
////	std::cout << "Long of Ascending Node: " << toDegrees(Om) << std::endl;
////	std::cout << "Arg of Pericenter:      " << toDegrees(w) << std::endl;
////	std::cout << "Mean Anomaly (EPOCH):   " << toDegrees(M0) << std::endl;
//}
//
...
//}
//
//vec3d_t EllipticalOrbit::positionAtE(double E)
//{
//	return vec3d_t(0, 0, 0);
//}
//
//vec3d_t EllipticalOrbit::position(double jd)
//{
//	double  meanMotion  = (PI * 2.0) / T;
...
//}
//
//vec3d_t EllipticalOrbit::velocity(double jd)
//{
//	double  meanMotion  = (PI * 2.0) / T;
//	double  meanAnomaly = M0 + (jd - epoch) * meanMotion;
//	double  E = solveForEccentricAnomaly(meanAnomaly);
...
//	T = (2*PI * sqrt((a*a*a) / GM)) / SECONDS_PER_DAY;
//	epoch = t;
//
////	eccentricity = e;
////	inclination = i;
